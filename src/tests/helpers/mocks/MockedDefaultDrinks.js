const value = 'Ordinary Drink';
const value2 = 'Grand Marnier';
const value3 = 'Shot glass';
const value4 = 'Baileys irish cream';
export const mockedDefaultDrinks = {
  drinks: [
    {
      idDrink: '15997',
      strDrink: 'GG',
